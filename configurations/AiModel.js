    ...
    history: [
      {
        role: 'user',
        parts: [
          { text: 'Generate exam material detail content for each chapter , Make sure to includes all topic point in the content, make sure to give content in HTML format (Do not Add HTMLK , Head, Body, title tag), The chapters : "chapters": [\n    {\n      "chapter_title": "Phase 1: Origin Stories",\n      "summary": "Introduction to the foundational Marvel heroes and the events that set the stage for the larger MCU narrative.",\n      "topics": [\n        "Iron Man (2008)",\n        "The Incredible Hulk (2008)",\n        "Iron Man 2 (2010)",\n        "Thor (2011)",\n        "Captain America: The First Avenger (2011)",\n        "The Avengers (2012)"\n      ]\n    },\n\n' },
        ],
      },
      {
        role: 'model',
        parts: [
          { text: '```html\n<h3>Phase 1: Origin Stories</h3>\n<p>This section covers the foundational Marvel heroes and the events that established the larger MCU narrative.  Exam questions will assess your understanding of the individual films, their interconnections, and their contribution to the overall MCU mythology.</p>\n\n<h4>Iron Man (2008)</h4>\n<ul>\n  <li>Tony Stark\'s character arc: from self-centered billionaire to responsible hero.</li>\n  <li>The creation of the Iron Man suit and its technological advancements.</li>\n  <li>Tony\'s relationship with Obadiah Stane and the conflict\'s resolution.</li>\n  <li>Introduction of key supporting characters: Pepper Potts, James Rhodes (as War Machine).</li>\n  <li>The film\'s impact on setting the tone and style of the MCU.</li>\n</ul>\n\n<h4>The Incredible Hulk (2008)</h4>\n<ul>\n  <li>Bruce Banner\'s transformation into the Hulk and the struggle for control.</li>\n  <li>The scientific aspects of the Hulk\'s creation and powers.</li>\n  <li>General Ross\'s pursuit of the Hulk and his motivations.</li>\n  <li>Emil Blonsky\'s transformation into Abomination and the consequences.</li>\n  <li>The film\'s connection to the wider MCU (minimal, but present).</li>\n</ul>\n\n<h4>Iron Man 2 (2010)</h4>\n<ul>\n  <li>Tony Stark dealing with the palladium poisoning and its impact on his health and actions.</li>\n  <li>Introduction of Black Widow and her role in S.H.I.E.L.D.</li>\n  <li>The conflict with Ivan Vanko/Whiplash and his motivations.</li>\n  <li>The development of the relationship between Tony Stark and James Rhodes.</li>\n  <li>The introduction of Nick Fury and further hints at the Avengers Initiative.</li>\n</ul>\n\n<h4>Thor (2011)</h4>\n<ul>\n  <li>Thor\'s banishment from Asgard and his journey of self-discovery on Earth.</li>\n  <li>The introduction of Asgard and its inhabitants.</li>\n  <li>The conflict with Loki and his motivations.</li>\n  <li>The interaction between Asgardian and human technologies and cultures.</li>\n  <li>Thor\'s transformation from arrogant prince to a more responsible hero.</li>\n</ul>\n\n<h4>Captain America: The First Avenger (2011)</h4>\n<ul>\n  <li>Steve Rogers\'s transformation into Captain America and his wartime experiences.</li>\n  <li>The historical context of World War II and its impact on the narrative.</li>\n  <li>The conflict with Johann Schmidt/Red Skull and HYDRA.</li>\n  <li>The introduction of the Tesseract and its importance to the MCU.</li>\n  <li>Captain America\'s character arc and his moral compass.</li>\n</ul>\n\n<h4>The Avengers (2012)</h4>\n<ul>\n  <li>The formation of the Avengers team and the challenges they face.</li>\n  <li>The individual character dynamics and their interactions.</li>\n  <li>Loki\'s plan to invade Earth and his motivations.</li>\n  <li>The battle of New York and its impact on the world.</li>\n  <li>The film\'s significance as the culmination of Phase 1 and its establishment of the MCU\'s shared universe.</li>\n</ul>\n```\n' },
        ],
      },
    ],
  });
