    ...
    <div className='border rounded-lg shadow-md p-5'>
        <div>
            <div className='flex justify-between items-center'>
                ...
                <h2 className='text-[10px] p-1 px-2 rounded-full bg-primary text-white'>20 April 2024</h2>
            </div>
            ...
            <div className='mt-3 flex justify-end'>
                ...
                <h2 className='text-sm p-1 px-2 flex gap-2 items-center rounded-full bg-slate-400 text-white'>
